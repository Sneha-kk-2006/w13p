...
// const Wishlist = require('../../models/wishlistSchema'); // ✅ add this
...
const addToCart = async (req, res) => {
    try {
        ...
        let cart = await Cart.findOne({ userId });          // ✅ Capital C
        if (!cart) cart = new Cart({ userId, items: [] }); // ✅ Capital C
        ...
        // await Wishlist.updateOne(                          // ✅ now defined
        //     { userId },
...
module.exports={addToCart,getcart,updateCartQty}